webpackJsonp([0], [, , , , , , , , , , , , , , , , function(t, e, s) {
    ...
    t.exports = {
        be: {
            translation: {
                ...
                "РћС‚Р»РёС‡РЅРѕ. Последний шаг!": "Р’С‹РґР°С‚РЅР°. РђРїРѕС€РЅС– РєСЂРѕРє!",
                ...
                "Последний шаг": "РђРїРѕС€РЅС– РєСЂРѕРє",
                ...
                "РЎ": "Р—",
                "политикой конфиденциальности": "РїР°Р»С–С‚С‹РєР°Р№ РїСЂС‹РІР°С‚РЅР°СЃС†С–",
        ...
        en: {
            translation: {
                ...
                "РћС‚Р»РёС‡РЅРѕ. Последний шаг!": "Excellent. Last step!",
        ...
        hy: {
            translation: {
                ...
                "РћС‚Р»РёС‡РЅРѕ. Последний шаг!": "ХЂХ«ХЎХ¶ХЎХ¬Х« Х§. ХЋХҐЦЂХ»Х«Х¶ Ц„ХЎХµХ¬!",
                ...
                "Спасибо": "Х‡Х¶ХёЦЂХ°ХЎХЇХЎХ¬ХёЦ‚Х©ХµХёЦ‚Х¶",
                "Р“РѕС‚РѕРІРѕ": "ХЉХЎХїЦЂХЎХЅХї Х§",
                "РќР°Р·Р°Рґ": "ХЂХҐХї",
                "Р”Р°Р»РµРµ": "ХЂХЎХ»ХёЦЂХ¤ХЁ",
                "Последний шаг": "ХЋХҐЦЂХ»Х«Х¶ Ц„ХЎХµХ¬",
                "РЎРґРµР»Р°РЅРѕ СЃ РїРѕРјРѕС‰СЊСЋ": "Powered by",
                Email: "Email",
                "Name": "Имя",
                ...
                "РЎ": "ХЈ",
                " ознакомлен": "Х®ХЎХ¶ХёХ©ХЎЦЃХ¶ХёЦ‚Хґ Х§",
                "политикой конфиденциальности": "ФіХЎХІХїХ¶Х«ХёЦ‚Х©ХµХЎХ¶ Ц„ХЎХІХЎЦ„ХЎХЇХЎХ¶ХёЦ‚Х©ХµХёЦ‚Х¶",
        ...
        kk: {
            translation: {
                ...
                "РћС‚Р»РёС‡РЅРѕ. Последний шаг!": "РўР°РјР°С€Р°. РЎРѕТЈТ“С‹ Т›Р°РґР°Рј!",
                ...
                "Р”Р°Р»РµРµ": "РђР»Т“Р°",
                "Последний шаг": "РЎРѕТЈТ“С‹ Т›Р°РґР°Рј",
                ...
                "РЎ": "",
                " ознакомлен": "С‚Р°РЅС‹СЃС‚С‹СЂС‹Р»Т“Р°РЅ",
                "политикой конфиденциальности": "ТљТ±РїРёСЏР»С‹Р»С‹Т› СЃР°СЏСЃР°С‚С‹",
        ...
        ru: {
            translation: {
                ...
                "РћС‚Р»РёС‡РЅРѕ. Последний шаг!": "РћС‚Р»РёС‡РЅРѕ. Последний шаг!",
        ...
        uk: {
            translation: {
                ...
                "РћС‚Р»РёС‡РЅРѕ. Последний шаг!": "Р”РѕР±СЂРµ, РѕСЃС‚Р°РЅРЅС–Р№ РєСЂРѕРє!",
                ...
                "Спасибо": "Р”СЏРєСѓС”РјРѕ",
                "Р“РѕС‚РѕРІРѕ": "Р“РѕС‚РѕРІРѕ",
                "РќР°Р·Р°Рґ": "РќР°Р·Р°Рґ",
                "Р”Р°Р»РµРµ": "Р”Р°Р»С–",
                "Последний шаг": "РћСЃС‚Р°РЅРЅС–Р№ РєСЂРѕРє",
                ...
                "РЎ": "РЎ",
                "политикой конфиденциальности": "РїРѕР»С–С‚РёРєРѕСЋ РєРѕРЅС„С–РґРµРЅС†С–Р№РЅРѕСЃС‚С–",
                " ознакомлен": "РѕР·РЅР°Р№РѕРјР»РµРЅРёР№",
        ...
        zh: {
            translation: {
                ...
                "РћС‚Р»РёС‡РЅРѕ. Последний шаг!": "еҐЅзљ„пјЊжњЂеђЋдёЂж­Ґ",
                ...
                "РЎ": "",
                "политикой конфиденциальности": "ж€‘е·Ій…иЇ»йљђз§Ѓ",
                " ознакомлен": "ж”їз­–",
    ...
    s.i(D.a)(), n.a.use(r.a), n.a.use(d.a), n.a.use(N.a), n.a.use(g.a), n.a.use(m.a), n.a.use(M.a), n.a.use(p.a), n.a.use(b.a), n.a.use(h.a, {}), n.a.use(f.a, {
        translations: w.a,
        lang: c.a.state.lang
    }), n.a.use(I.a), n.a.config.productionTip = !1, s(143), l.a.parse(window.location.search).debug, new n.a({
        el: "#app",
        store: c.a,
        router: T.a,
        template: "<App/>",
    ...
    var i = function() {
            ...
            }, [t._v(t._s(t.$t("Спасибо")) + "! рџ‘Џ")]), s("p", {
    ...
    var i = function() {
            ...
            }), s("span", [t._v()])], 1) : t._e(), t.messengersPage ? t._e() : s("button", {
            ...
            }, [t._v(t._s(t.$t("политикой конфиденциальности")))]), t._v(t._s(t.$t(" ознакомлен")))])], 1)])
        },
        n = [],
        a = {
            render: i,
    ...
    var i = function() {
            ...
            }, [t._v(t._s(t.$t("Назад")))])]), t.isLast ? t._e() : s("button", {
            ...
            }, [s("CheckDone")], 1), s("span", [t._v(t._s(t.$t("Далее")))])]), t.isLast ? s("button", {
    ...
    var i = function() {
            ...
            return s("div", {
                ...
                domProps: {
                    innerHTML: t._s(t.title || t.$t("РћС‚Р»РёС‡РЅРѕ. Последний шаг!"))
                }
            }), t.info.form.title2 && t.isStep2 ? s("p", {
                staticClass: "title final-page__title",
                domProps: {
            ...
            }, [s("span", [t._v(t._s(t.$t("Итоговая скидка:")) + ":")]), s("div", {
